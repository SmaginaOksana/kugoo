...
export function Button({
  ...
  const typesOfButton: {
    ...
    white: "bg-white text-purple hover:bg-purple hover:text-white rounded-sm-5",
    orange: "bg-orange text-white hover:bg-orange-light rounded-sm-5",
    gray: "bg-gray text-light-gray hover:bg-white hover:text-purple border border-white hover:border-purple rounded-sm-5",
    ...
    prev: `w-full h-full border-none bg-[url("@/assets/arrows/arrowSmallLeftPurple.png")] hover:bg-[url("@/assets/arrows/arrowSmallLeft.png")] bg-no-repeat bg-center`,
    next: `w-full h-full border-none bg-[url("@/assets/arrows/arrowSmallRightPurple.png")] hover:bg-[url("@/assets/arrows/arrowSmallRight.png")] bg-no-repeat bg-center`,
